      ...
      image: (
        <div tw="flex flex-col bg-[#121212] text-white p-5 w-full h-full items-center justify-center">
          ...
          <div tw="text-2xl text-center pr-5 pl-5">
            ...
            used to assess the overall quality of a user profile, with scores
            ranging from 0 to 10,000 where higher scores denote better quality.
          </div>
        </div>
      ),
      buttons: [
        ...
        <Button target={"/profile1"} action="post">
          Back ⬅️
        </Button>,
